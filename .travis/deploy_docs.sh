...
if [ "$TRAVIS_REPO_SLUG" != "ofek/bitcoinpython" ] || [ "$TRAVIS_PULL_REQUEST" != "false" ] || [ "$TRAVIS_BRANCH" != "master" ]
then
...
git remote add upstream "https://$GH_TOKEN@github.com/ofek/bitcoinpython.git"
git fetch upstream
