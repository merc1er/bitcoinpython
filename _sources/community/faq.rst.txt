...
bitcoinpython uses `Bitcoin Core <https://github.com/bitcoin/bitcoin>`_'s heavily optimized C library `libsecp256k1 <https://github.com/bitcoin-core/secp256k1>`_
