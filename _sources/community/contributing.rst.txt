...
1. Go to `bitcoinpython's GitHub Issues <https://github.com/buymercier/bitcoinpython/issues>`_.
2. Look through open and closed issues to see if there has already been a
   similar bug report or feature request.
   `GitHub's search <https://github.com/buymercier/bitcoinpython/search>`_ feature may aid
   you as well.
3. If your issue doesn't appear to be a duplicate,
   `file an issue <https://github.com/buymercier/bitcoinpython/issues/new>`_.
4. Please be as descriptive as possible!

Pull Request
------------

1. Fork the repository `on GitHub <https://github.com/buymercier/bitcoinpython>`_.
...
2. Run `run_tests.py <https://github.com/buymercier/bitcoinpython/blob/master/run_tests.py>`_
...
5. Add any changes to the **Unreleased** section of
   `HISTORY.rst <https://github.com/buymercier/bitcoinpython/blob/master/HISTORY.rst>`_.

Documentation
^^^^^^^^^^^^^

1. Enter the `docs <https://github.com/buymercier/bitcoinpython/tree/master/docs>`_ directory.
